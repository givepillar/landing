        ...
        <div className="wrap max-w-2xl mx-auto">
          ...
          <ol type="a">
            ...
            <li>
              ...
              these restrictions and may be terminated by Pillar at any time.
          ...
          <ol type="a">
            <li>
              The materials on Pillar's website are provided on an 'as is'
              basis. Pillar makes no warranties, expressed or implied, and
          ...
          <p>
            ...
            to use the materials on Pillar's website, even if Pillar or a Pillar
          ...
          <p>
            ...
            current. Pillar may make changes to the materials contained on its
            website at any time without notice. However Pillar does not make any
            commitment to update the materials.
          </p>
          <h3>6. Links</h3>
          <p>
            Pillar has not reviewed all of the sites linked to its website and
